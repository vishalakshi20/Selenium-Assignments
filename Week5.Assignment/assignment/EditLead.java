...
public class EditLead extends BaseClass{
	...
	public  void editlead(String UpdateCompanyName) throws InterruptedException  {
		...
		driver.findElement(By.id(UpdateCompanyName)).sendKeys("Google");
		Thread.sleep(2000);
	...
	public Object[][] fetchData() throws InvalidFormatException, IOException{
		...
		String[][] data = ReadExcel.readExcel("Edit Lead");
		return data;
